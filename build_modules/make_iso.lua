    ...
    local module = {
        ...
        info = {
            commands = {
                ...
                "cp -v deps/limine/bin/limine-bios.sys deps/limine/bin/limine-bios-cd.bin deps/limine/bin/limine-uefi-cd.bin iso_root/boot/limine/",
                "cp -v deps/limine/bin/BOOTX64.EFI iso_root/EFI/BOOT/",
                "cp -v deps/limine/bin/BOOTAA64.EFI iso_root/EFI/BOOT/",
                "cp -v deps/limine/bin/BOOTLOONGARCH64.EFI iso_root/EFI/BOOT/",
                "cp -v deps/limine/bin/BOOTRISCV64.EFI iso_root/EFI/BOOT/",
                xorriso_command[arch],
                "./deps/limine/bin/limine bios-install output-" .. arch .. ".iso",
                "rm -rf iso_root"
            },
            run_mode = "rerun",
        }
